...
@section('content')
    <div class="container">
        <div class="row g-5">
                    ...
                    <form action="{{ route('films.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                ...
                                <input type="text" name="director" required value="{{ old('director') }}"
                                    class="form-control shadow-sm @error('director') is-invalid @enderror">
                                @error('director')
                                    <div class="invalid-feedback fw-bold">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-6">
                                ...
                                <input type="number" name="year" required value="{{ old('year') }}"
                                    class="form-control shadow-sm @error('year') is-invalid @enderror">
                                @error('year')
                                    <div class="invalid-feedback fw-bold">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="genre" required value="{{ old('genre') }}"
                                class="form-control shadow-sm @error('genre') is-invalid @enderror">
                            @error('genre')
                                <div class="invalid-feedback fw-bold">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="image" placeholder="https://..." value="{{ old('image') }}"
            ...
            <div class="col-lg-8">
                <div
                    class="d-flex justify-content-between align-items-end mb-4 border-bottom border-secondary border-opacity-25 pb-3">
                            ...
                            <div class="col-md-6 col-xl-4">
                                ...
                                <div class="card bg-transparent border-0 h-100 movie-card text-white">
                                    ...
                                    <div class="position-relative w-100"
                                        style="height: 350px; background-color: rgba(30, 41, 59, 0.8);">
                                        @if ($film->image)
                                            <img src="{{ $film->image }}" class="w-100 h-100 object-fit-cover"
                                                alt="{{ $film->title }}">
                                        @else
                                            <div
                                        ...
                                        <div class="position-absolute bottom-0 start-0 w-100 p-3"
                                            ...
                                            <h5 class="card-title fw-bold m-0 text-truncate" title="{{ $film->title }}">
                                                {{ $film->title }}</h5>
                                            <small
                                                class="text-secondary opacity-75 d-block text-truncate">{{ $film->director }}</small>
                                        </div>
                                        ...
                                        <div class="position-absolute top-0 end-0 m-2 d-flex gap-2" style="opacity: 0.9;">
                                            ...
                                            <a href="{{ route('films.edit', $film->id) }}"
                                                class="btn btn-warning rounded-circle shadow-sm text-dark"
                                                style="width:40px; height:40px; display:flex; align-items:center; justify-content:center;"
                                                title="Edit Film">
